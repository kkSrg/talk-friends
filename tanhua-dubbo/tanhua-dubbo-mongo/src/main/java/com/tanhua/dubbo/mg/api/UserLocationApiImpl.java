...
import com.tanhua.mongo.pojo.UserLocation;
...
public class UserLocationApiImpl implements UserLocationApi {
    ...
    @Override
    public List<Long> search(Long uid, Double metre) {
        //1. 根据uid查询登录者当前坐标
        Query queue = Query.query(Criteria.where("userId").is(uid));
        UserLocation userLocation = mongoTemplate.findOne(queue, UserLocation.class);
